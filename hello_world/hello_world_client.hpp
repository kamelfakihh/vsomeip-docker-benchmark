...
public:
    ...
    hello_world_client() :
                    ...
                    app_(rtm_->create_application("hello_world_client")),
                    bench()
    {
    }
    ...
    void on_message_cbk(const std::shared_ptr<vsomeip::message> &_response)
    {
                ...
                && vsomeip::return_code_e::E_OK == _response->get_return_code())
        {
            ...
            bench.stop();
            bench_measurer::usec_t time_needed = bench.get_elapsed_us();
            std::cout << "RTT [usec] " << std::dec << std::setw(8) << std::setfill('0') << time_needed << std::endl;
            stop();
        }
    }
